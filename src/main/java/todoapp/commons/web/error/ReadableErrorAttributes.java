 ...
 * <p>
 * DefaultErrorAttributes는 message 속성을 예외 객체의 값을 사용하기 때문에 사용자가 읽기에 좋은 문구가 아니다. 해당 메시지를 보다 읽기 좋은 문구로
 * 가공해서 제공하는 것을 목적으로 만들어졌다.
 *
...
public class ReadableErrorAttributes implements ErrorAttributes, HandlerExceptionResolver, Ordered {
    ...
    public Map<String, Object> getErrorAttributes(WebRequest webRequest, ErrorAttributeOptions options) {
        ...
        if (Objects.nonNull(error)) {
            ...
            var errorMessage = messageSource.getMessage(errorCode, new Object[0],
                    error.getMessage(), webRequest.getLocale());
